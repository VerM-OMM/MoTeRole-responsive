        ...
        <>
            <div className="flex h-screen flex-col justify-center">
                ...
                <div className="container relative mx-auto h-[600px] rounded-[30px] border-[10px] border-grape bg-white/30">
                    {/* title */}
                    <span className="text-shadow container absolute -top-[25%] mx-auto text-center font-bubbles text-9xl text-white lg:text-7xl">
                        MoTeRole
                    </span>
                    <form
                        action=""
                    ...
                    >
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex space-x-6">
                                {/* first name */}
                                <input
                                    className="flex h-24 w-full items-center rounded-3xl border-[6px] border-grape px-5 text-5xl focus:outline-none"
                                    type="text"
                                    name="firstname"
